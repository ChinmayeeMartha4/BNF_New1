...
import com.example.mhealth.Activity_childListing;
...
public class ChildListAdapter extends ArrayAdapter {
    ...
    public ChildListAdapter(Activity_childListing context, ArrayList<Child> list, ArrayList<Object> strindexData) {
    ...
    public View getView(final int position, View convertView, ViewGroup child) {
        ...
        textview3.setText(":" + " " + dateFormatConvert(childObject.getDate_of_birth()));
