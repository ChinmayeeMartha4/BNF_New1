...
import com.example.mhealth.adapter.EditChildListAdapter;
...
public class Activity_EditChildListing extends Activity implements
        OnItemClickListener {
    ...
    private EditChildListAdapter adapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        t.setScreenName(GlobalVars.username + "-> Edit/ Edit Child Registration HB List");
        ...
        //adapter = new EditChildListAdapter(this, list, strindexData);
        adapter = new EditChildListAdapter(this, list, strindexData);
...
//			intChildId = helper.getChildId(getChildName,getChildId);
            ...
            Intent ChildData = new Intent(this, Activity_EditChild.class);
    ...
    public void onBackPressed() {
        ...
        builder.setNegativeButton(strYes, new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                Intent intent = new Intent(Activity_EditChildListing.this,
                        ActivityEdit.class);
