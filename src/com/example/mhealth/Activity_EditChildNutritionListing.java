...
import com.example.mhealth.adapter.EditChildNutritionListAdapter;
...
public class Activity_EditChildNutritionListing extends Activity implements
        OnItemClickListener {
    ...
    private EditChildNutritionListAdapter adapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        t.setScreenName(GlobalVars.username + "-> Edit/Edit Child Nutrition HB List");
        ...
        adapter = new EditChildNutritionListAdapter(this, list, strindexData);
    ...
    public void onItemClick(AdapterView<?> arg0, View view, int arg2, long arg3) {
        ...
        String ici = tvchildId.getText().toString().replaceAll(":", "").trim();
        ...
        try {
            ...
            Intent ChildData = new Intent(this, Activity_EditChildNutritionHB.class);
    ...
    public void onBackPressed() {
        ...
        builder.setNegativeButton(strYes, new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                Intent intent = new Intent(Activity_EditChildNutritionListing.this,
                        ActivityEdit.class);
